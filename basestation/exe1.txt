...
Osmo-nitb : http://ftp.osmocom.org/docs/latest/osmonitb-usermanual.pdf

In this section, the goal is to get familiarised with the configuration of the setup. In order to build your own base station, below are some important concepts/configurations that you have to know to setup. 
